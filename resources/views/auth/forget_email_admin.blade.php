...
@section('title', 'Admin - Forgot Email')
        ...
        <div class="hold-transition login-page">
            <div class="login-box">
                <div class="text-center">
                    ...
                    <h4 class="mt-3">Admin - Forgot Your Email?</h4>
                    <p class="text-muted">Enter your admin mobile number to retrieve your email</p>
                </div>
                <form method="POST">
                    @csrf
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('signin_option_admin') }}">Back to Sign In Options</a>
                    </div>
                </form>
            </div>
        </div>
