<!--<a class="brand-link" href="<?php echo e(route('driver.dashboard')); ?>">

<img src="<?php echo e(asset('icons/zyco4.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"> -->
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light topbak toptext">
        ...
        <ul class="nav navbar-nav  ml-5">
            ...
            <!--	<li class="nav-item d-none d-sm-inline-block">
			 ...
			 <li class="nav-item d-none d-sm-inline-block">
				...
				<a href="<?php echo e(route('mygroup')); ?>" class="nav-link">
    ...
    <!-- <form action="<?php echo e(route('searchResult')); ?>" method="POST">
        ...
        <ul class="nav navbar-nav ">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <button onclick="updateSingleData(<?php echo e(Auth::user()->id); ?>,'users','driver_activity_status','1')"
                        class="dropdown-item"><?php if(Auth::user()->driver_activity_status == 1): ?><i class="fas fa-check"></i>

                        <span class="float-right text-muted text-sm"><span
                                class="p-1 bg-success border border-light"></span></span>

                        <?php endif; ?> Online</button>

                    <div class="dropdown-divider"></div>

                    <button onclick="updateSingleData(<?php echo e(Auth::user()->id); ?>,'users','driver_activity_status','2')"
                        class="dropdown-item"><?php if(Auth::user()->driver_activity_status == 2): ?><i class="fas fa-check"></i>

                        <span class="float-right text-muted text-sm"><span
                                class="p-1 bg-danger border border-light "></span></span>

                        <?php endif; ?> Offline</button>

                    <div class="dropdown-divider"></div>

                    <button onclick="updateSingleData(<?php echo e(Auth::user()->id); ?>,'users','driver_activity_status','3')"
                        class="dropdown-item"><?php if(Auth::user()->driver_activity_status == 3): ?><i class="fas fa-check"></i>

                        <span class="float-right text-muted text-sm"><span
                                class="p-1 bg-warning  border border-light "></span></span>

                        <?php endif; ?> Busy</button>

                    <div class="dropdown-divider"></div>

                    <button onclick="updateSingleData(<?php echo e(Auth::user()->id); ?>,'users','driver_activity_status','0')"
                        class="dropdown-item"><?php if(Auth::user()->driver_activity_status == 0): ?><i
            ...
            <li class="nav-item dropdown">
                <a class="nav-link " data-toggle="dropdown" href="#">
                    <img src="<?php echo e(asset('icons/layoutIcons/chat.png')); ?>" alt="" class="topnavothericon" />
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link " data-toggle="dropdown" href="#">
                    <!--	src="<?php echo e(asset('icons/layoutIcons/active.png')); ?>"-->
                    <img src="<?php echo e(asset('icons/layoutIcons/Notification.png')); ?>" alt=""
            ...
            <span class="float-right text-muted text-sm">3 mins</span>
                    ...
                    <div class="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
                        <div class="dropdown-list-image mr-3">
                            ...
                            <img class="rounded-circle" src="<?php echo e(asset('group_photo/'.$group_logo)); ?>"
                                alt="Group Logo">
                            <?php else : ?>
            ...
            <li class="nav-item dropdown  ">
                ...
                <a class="nav-link " data-toggle="dropdown" href="#">
                    <img class=" menu-profile-avatar" id="menu-avatar" alt="Avatar"
                        <?php if(empty($user_profileInfo->profile_picture)): ?>
                    ...
                    <?php endif; ?>>
                    <img src="<?php echo e(asset('icons/layoutIcons/caret-down.png')); ?>"
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right  dropdown-profile">
                    ...
                    <div class="dropdown-profile-div row">
                        ...
                        <div class="col-6 ">
                            ...
                            <small><?php echo e(Auth::guard('admin')->user()->username); ?> </small> <br>
                            <?php elseif(Auth::user()): ?>

                            <small><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?> </small> <br>
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="<?php echo e(route('profileUpdate')); ?>" class="dropdown-item">
                        My Profile
                    </a>


                    <a href="<?php echo e(route('upgrade_profile_packages')); ?>" class="dropdown-item">
                        My Subscription
                    </a>
                    <a href="<?php echo e(route('my_wallet')); ?>" class="dropdown-item">
                        Wallet
                        <span class="float-right text-sm"><?php if(!empty(Auth::user()->currency_code)): ?>
                            <?php echo e(Auth::user()->currency_code); ?> <?php endif; ?> <?php echo e(number_format($balance,2)); ?></span>
                    </a>
                    ...
                    <a class="dropdown-item " data-slide="true" href="<?php echo e(route('signout')); ?>" role="button">Sign out <i
...
</script><?php /**PATH D:\Dream\Laravel Deep Learning\zyco\resources\views/backend/navbar.blade.php ENDPATH**/ ?>