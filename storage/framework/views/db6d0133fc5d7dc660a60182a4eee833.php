...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/bs-stepper/css/bs-stepper.min.css')); ?>">
        ...
        <!-- DataTables -->
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')); ?>">
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')); ?>">
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/plugins/datatables-searchbuilder/css/searchBuilder.bootstrap4.min.css')); ?>">
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')); ?>">
        ...
        <!-- overlayScrollbars -->
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')); ?>">
        <!-- Daterange picker -->
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/user-profile-update.css')); ?>" />
        <!-- jQuery UI 1.11.4 -->
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/colorpicker/jquery.colorpicker.css')); ?>" />

        <script src="<?php echo e(asset('assets/plugins/colorpicker/jquery.colorpicker.js')); ?>"></script>
    ...
    @font-face {
        font-family: 'lato';
        font-style: normal;
        src: url('<?php echo e(asset('assets/fonts/lato/Lato-Regular.ttf')); ?>');
    }
    ...
    <body class="sidebar-mini  layout-fixed layout-footer-fixed   ">
        ...
        <div class="wrapper">
            ...
            <div class="preloader flex-column justify-content-center align-items-center">
                <img class="animation__shake" src="<?php echo e(asset('icons/zyco4.png')); ?>" alt="AdminLTELogo"
            ...
            <?php echo $__env->make('backend.nav_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php
            ...
            ?>
            <?php else: ?>
            <?php echo $__env->make('backend.navbarAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('backend.navSidebarAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php
    ...
    <div class="float-right d-none d-sm-inline-block">    
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-block">
                                        <input type="color" class="form-control form-control-sm form-control-color"
                                            name="top_bg" value="<?php echo e($theme_top_bg); ?>"
                                            onchange="theme_customize('top_bg',this.value)" title="Choose your color"
                                            id="top_bak">
                                        <button class="btn btn-default btn-sm" name="top_text"
                                            value="<?php echo e($theme_top_bg); ?>" onclick="theme_customize('top_bg','')"
                                            title="Set Default" id="top_text"><i class="fas fa-redo fa-sm"></i></button>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-block">
                                        <input type="color" class="form-control form-control-sm form-control-color"
                                            name="side_text" value="<?php echo e($theme_side_text); ?>"
                                            onchange="theme_customize('side_text',this.value)"
                                            title="Choose your color">
                                        <button class="btn btn-default btn-sm" name="top_text"
                                            value="<?php echo e($theme_side_text); ?>" onclick="theme_customize('side_text','')"
                                            title="Set Default" id="top_text"><i class="fas fa-redo fa-sm"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-block">
                                        <input type="color" class="form-control form-control-sm form-control-color"
                                            name="side_bg" value="<?php echo e($theme_side_bg); ?>"
                                            onchange="theme_customize('side_bg',this.value)" title="Choose your color">
                                        <button class="btn btn-default btn-sm" name="top_text"
                                            value="<?php echo e($theme_side_bg); ?>" onclick="theme_customize('side_bg','')"
                                            title="Set Default" id="top_text"><i class="fas fa-redo fa-sm"></i></button>
                                    </div>
            ...
            <script src="<?php echo e(asset('assets/plugins/datatables-responsive/js/dataTables.responsive.min.js')); ?>">
            </script>
            <script src="<?php echo e(asset('assets/plugins/datatables-responsive/js/responsive.bootstrap4.min.js')); ?>">
            </script>
            <script
                src="<?php echo e(asset('assets/plugins/datatables-searchbuilder/js/dataTables.searchBuilder.min.js')); ?>">
            </script>
            <script
                src="<?php echo e(asset('assets/plugins/datatables-searchbuilder/js/searchBuilder.bootstrap4.min.js')); ?>">
            </script>
            ...
            <script src="<?php echo e(asset('assets/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')); ?>">
            </script>
...
<script src="https://cdn.jsdelivr.net/gh/RubaXa/Sortable/Sortable.min.js"></script>
 ...
 <script type="module" src="<?php echo e(asset('assets/js/admin.js')); ?>"></script> 
<script src="https://zyco-bv.firebaseio.com/"></script>-->

            <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/bs-stepper/js/bs-stepper.min.js')); ?>">
            ...
            switch (type) {
                ...
                case 'success':
                    ...
                    break;
                case 'warning':
                    toastr.succewarningss("<?php echo e(Session::get('status')); ?>");
                    break;
                case 'error':
...
</html><?php /**PATH D:\Dream\Laravel Deep Learning\zyco\resources\views/backend/web_admin.blade.php ENDPATH**/ ?>